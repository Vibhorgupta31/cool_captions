...
# Note Message
st.markdown("<p><b>Note: </b><emph>Howdy Web Wanderers! <br/>Thanks a bunch for swinging by our site. If the caption magic hits a snag, just retry  a couple of times  – it's got some serious charm. 🌟 Cheers to error-free adventures! 🚀 </emph></p>", unsafe_allow_html=True, help=None)
